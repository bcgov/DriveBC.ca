    ...
    <div className="popup popup--route" tabIndex={0}>
      ...
      <div className="popup__content">
        <div className="popup__content__title">
          ...
          <p>Route name</p>
          <p>Route distance {routeObjects.distance}{routeObjects.distanceUnit}</p>
        </div>
        ...
        {routeObjects.majorEvents &&
          <div className="route-item">
            ...
            <span className="route-item__icon">
              <svg width="18" height="19" viewBox="0 0 18 19" fill="#605E5C" xmlns="http://www.w3.org/2000/svg" alt="major delays" aria-hidden="true" focusable="false" role="img">
        ...
        {routeObjects.minorEvents &&
          <div className="route-item">
            ...
            <span className="route-item__icon">
              <svg width="18" height="16" viewBox="0 0 18 16" fill="#605E5C" xmlns="http://www.w3.org/2000/svg" alt="minor delays" aria-hidden="true" focusable="false" role="img">
        ...
        {routeObjects.roadConditions &&
          <div className="route-item">
            ...
            <span className="route-item__icon">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="#605E5C" xmlns="http://www.w3.org/2000/svg" alt="road conditions" aria-hidden="true" focusable="false" role="img">
