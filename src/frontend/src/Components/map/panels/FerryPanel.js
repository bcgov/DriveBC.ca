    ...
    if (twitterMatch) {
      return (
        ...
        <div className="data-icon">
          ...
          <p className="data">@{twitterMatch[1]}
          </p>
        </div>        
      );
    }
            ...
            <div className='info__container'>
              ...
              {ferryData.contact_phone &&
                <div className="data-card__row">
                  ...
                  <p className="data"><a href={"tel:" + formatPhoneNumber(ferryData.contact_phone)}>{formatPhoneNumber(ferryData.contact_phone)}</a>
                  </p>
                </div>
              }
              {ferryData.contact_alt_phone &&
                <div className="data-card__row">
                  ...
                  <p className="label">{ferryData.contact_phone ? 'Alternate phone' : 'Phone'}</p>
                  <p className="data"><a href={"tel:" + formatPhoneNumber(ferryData.contact_alt_phone)}>{formatPhoneNumber(ferryData.contact_alt_phone)}</a>
                  </p>
                </div>
              }                
              {ferryData.contact_fax &&
                <div className="data-card__row">
                  ...
                  <p className="data">{formatPhoneNumber(ferryData.contact_fax)}
                  </p>
                </div>
              }
              {ferryData.contact_email &&
                <div className="data-card__row">
                  ...
                  <p className="data"><a href={"mailto:" + ferryData.contact_email}>{ferryData.contact_email}</a>
                  </p>
                </div>
              }
