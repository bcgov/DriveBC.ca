        ...
        <div className="filter-group">
          ...
          <div className="filter-items-group">
            <div className="filter-items filter-items--conditions">
              ...
              <div className={'filter-item filter-item--wildfires' + (wildfires ? ' checked' : '') + (disableFeatures ? ' disabled' : '') + ((loadingLayers && loadingLayers.wildfires) ? ' loading' : '')}>
                <input
                  type="checkbox"
                  name="wildfires"
                  id="filter--wildfires"
                ...
                <label className="filter-item__button" htmlFor="filter--wildfires">
                  <span className="filter-item__button__icon">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15.3906 7.47687L15.2111 7.7538C14.7175 8.3538 14.2688 8.53842 13.6406 8.53842C12.6085 8.53842 11.8008 7.70765 11.8008 6.59995V4.19995C11.8008 4.19995 5.47388 7.56918 5.47388 13.1218C5.47388 16.8737 8.52517 19.8 11.9355 19.8C15.6482 19.8 18.4867 16.7076 18.5315 13.2923C18.5613 11.0309 17.3982 8.64828 15.3906 7.47687ZM11.9803 18.4615C11.0563 18.4615 10.1406 17.7692 10.1406 16.6153C10.1406 15.9006 10.4496 15.5448 10.7688 15.2308L11.9803 13.9846L13.4162 15.4153C13.727 15.7294 13.8649 16.2461 13.8649 16.7538C13.8649 17.5384 13.1021 18.4615 11.9803 18.4615ZM15.0315 17.4923C15.0651 17.1867 15.4925 15.6674 14.3585 14.5384L11.9695 12.1846L9.64695 14.5384C8.50455 15.6759 8.89541 17.2036 8.92901 17.4923C8.43542 17.123 7.53799 16.1538 7.22388 15.323C6.92835 14.6643 6.73023 13.8452 6.73029 13.1218C6.73029 10.2 9.15337 7.56918 10.4995 6.6461C10.4995 7.47687 10.914 8.44468 11.5316 8.99995C12.1492 9.55522 12.8139 9.82948 13.6406 9.83072C14.2958 9.83072 14.9875 9.59572 15.5251 9.23072C16.6021 10.1538 17.2308 11.7204 17.2302 13.1076C17.2751 15.0923 16.1982 16.6615 15.0315 17.4923Z" fill="#CE3E39"/>
                  </svg>
                  </span>
                  Wildfires
                </label>
