...
export default function RouteObjectList(props) {
  ...
  // Props
  const { routeDetailIndex, setRouteDetailIndex } = props;
  ...
  const getObjectList = (objs) => {
    return objs.map((obj, index) => {
      switch (obj.display_category) {
        case 'closures':
          return (
            <div className="route-item route-item--major" key={index}>
        ...
        case 'roadConditions':
          return (
            <div className="route-item route-item--roadConditions">
              ...
              <span
                className="route-item__name">Road condition</span>
            </div>
          );
        case 'chainUps':
          return (
            <div className="route-item route-item--chainUps">
              ...
              <span
                className="route-item__name">Commercial chain up</span>
            </div>
          );
        default:
          // Ferries
      ...
      <div className={`route-details selected ${largeScreen ? 'mobile' : ''}`}>
        <div className="route-title">
          ...
          <div className="route-name-and-distance">
            <h4
              className="route-name">{selectedRoute.label ? selectedRoute.label : 'Route'} {(routeDetailIndex === 0) ? 'A' : 'B'}</h4>
