        ...
        <div className="report-problem">
          <div className="section section--online">
            ...
            <div className="section__content">
              <Link to="/website-problem" className="content-card content-card--website disabled">
          ...
          <div className="section section--phone">
            ...
            <div className="section__content">
              <div className="content-card content-card--power">
                <div className="circle-icon">
                  <FontAwesomeIcon icon={faUtilityPole} />
                </div>
                <p>Report downed power line</p>
                <a className="tel-number bold" href="tel:1-888-769-3766">1-888-769-3766</a>
              </div>
              <div className="content-card content-card--wildfire">
                <div className="circle-icon">
...
<path d="M0.00134277 22.1706C-0.0708885 16.6567 2.7783 10.8471 7.69802 7.99054L8.13763 8.66611C9.34697 10.1294 10.4467 10.5793 11.986 10.5793C14.5155 10.5793 16.4945 8.55394 16.4945 5.85305V0C16.4945 0 32 8.21488 32 21.755C32 30.5372 25.1091 37.459 17.1648 38V31.9068H23.0979L18.552 24.0957H20.9668L15.9955 16.4495L11.032 24.0957H13.4403L8.90086 31.9068H14.8339V37.9789C6.39717 37.2862 0.104486 30.0873 4.00543e-05 22.1706H0.00134277Z" fill="white"/>
                ...
                <p>Report a wildfire</p>
                <a className="tel-number bold" href="tel:1-800-663-5555">1-800-663-5555</a>
              </div>
              <div className="content-card content-card--chemical">
                <div className="circle-icon">
                  <FontAwesomeIcon icon={faFlask} />
                </div>
                <p>Report a chemical spill</p>
                <a className="tel-number bold" href="tel:1-800-663-3456">1-800-663-3456</a>
              </div>
            </div>
          </div>
        </div>
