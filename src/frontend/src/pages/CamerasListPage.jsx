...
export default function CamerasListPage() {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      ...
      if (showHwyFilters && hwyFilterRef.current && !hwyFilterRef.current.contains(event.target)) {
        setShowHwyFilters(false);
      }
    };

    // Desktop only
    if (!smallScreen && (showAreaFilters || showHwyFilters)) {
  ...
  }, [showAreaFilters, showHwyFilters]);
              ...
              <div className="controls-group">
                <div className="controls-container">
                  ...
                  <div className="tools-container">
                    ...
                    <div ref={hwyFilterRef} className="hwy-filter-container">
                      <Button
                        variant="outline-primary"
