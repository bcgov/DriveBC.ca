...
import { updateSearchedRoutes, updateSearchLocationFrom, updateSearchLocationTo } from "./slices/index";
...
import EmergencyAlertDetail from "./Components/shared/EmergencyAlertDetail";
...
function useVersionCheck() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(check, 60 * 60 * 1000); // refresh every hour
