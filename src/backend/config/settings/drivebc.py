...
NEW_DRIVEBC_IMAGE_BASE_URL = env("NEW_DRIVEBC_IMAGE_BASE_URL")
NEW_DRIVEBC_IMAGE_PROXY_URL = env("NEW_DRIVEBC_IMAGE_PROXY_URL")
...
# Timelapse API Key
TIMELAPSE_API_KEY = env("TIMELAPSE_API_KEY")
