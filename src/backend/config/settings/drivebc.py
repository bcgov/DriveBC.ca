...
RIDE_EVENT_API_URL = env("RIDE_EVENT_API_URL")

# DMS API Settings
DRIVEBC_DMS_API_BASE_URL1 = env("DRIVEBC_DMS_API_BASE_URL1")
DRIVEBC_DMS_API_BASE_URL2 = env("DRIVEBC_DMS_API_BASE_URL2") # Failover URL
DRIVEBC_DMS_API_KEY = env("DRIVEBC_DMS_API_KEY", default="")
